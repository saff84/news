...
from app.api import admin, ai_config, auth, competitors, developers, diagnostics, health, indicators, indicators_import, max_parser, monitoring, news, parsing_templates, regions, report_config, reports, sources, telegram_parser, templates, vk_parser
