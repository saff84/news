...
Структура: аналитические paragraphs + полный перечень bullets с citations в каждом subsection.
Заголовки subsections — ТОЛЬКО тематические; ЗАПРЕЩЕНЫ диапазоны дат.
В «Продукт и ассортимент» и «Маркетинг и продажи» — не менее 80% bullets из черновика по теме.
Схема:
{
  "headline": "конкурент + период",
  "lead": "стратегическая картина (4–6 предложений)",
  "subsections": [
    {
      "title": "Продукт и ассортимент",
      "paragraphs": ["аналитика", "тренды"],
      "bullets": [{"text": "конкретная новинка или артикул", "citations": [{"label": "...", "url": "..."}]}]
    }
  ],
  "closing": "вывод + мониторинг"
}
"""
